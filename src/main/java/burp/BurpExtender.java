...
public class BurpExtender implements IBurpExtender, IScannerCheck, IContextMenuFactory {
  ...
  public List<JMenuItem> createMenuItems(IContextMenuInvocation iContextMenuInvocation) {
    ...
    // TODO 添加 FuzzActiveScan, 如id=FUZZ
